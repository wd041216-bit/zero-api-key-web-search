...
- Public repo: `wd041216-bit/zero_api_key_web_search`
- Extension manifest: [`gemini-extension.json`](../gemini-extension.json)
- Root skill: [`skills/zero_api_key_web_search/SKILL.md`](../skills/zero_api_key_web_search/SKILL.md)
- Gemini context: [`GEMINI.md`](../GEMINI.md) and [`.gemini/SKILL.md`](../.gemini/SKILL.md)
- Package published: [`zero_api_key_web_search` on PyPI](https://pypi.org/project/zero_api_key_web_search/)
- Tagged release: [`v21.0.0`](https://github.com/wd041216-bit/zero_api_key_web_search/releases/tag/v21.0.0)
...
- Homepage: `https://pypi.org/project/zero_api_key_web_search/`
...
- The package keeps legacy compatibility aliases for existing users, but all new documentation points to `zero_api_key_web_search`.
