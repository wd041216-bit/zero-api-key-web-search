...
- Public repo: `wd041216-bit/zerosieve`
- Extension manifest: [`gemini-extension.json`](../gemini-extension.json)
- Root skill: [`skills/zerosieve/SKILL.md`](../skills/zerosieve/SKILL.md)
- Gemini context: [`GEMINI.md`](../GEMINI.md) and [`.gemini/SKILL.md`](../.gemini/SKILL.md)
- Package published: [`zerosieve` on PyPI](https://pypi.org/project/zerosieve/)
- Tagged release: [`v21.0.0`](https://github.com/wd041216-bit/zerosieve/releases/tag/v21.0.0)
...
- Homepage: `https://pypi.org/project/zerosieve/`
...
- The package keeps legacy compatibility aliases for existing users, but all new documentation points to `zerosieve`.
