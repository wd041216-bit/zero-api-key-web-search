...
from zero_api_key_web_search.laya_filter import add_laya_args, laya_backend_from_args, laya_search_kwargs
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Zero-API-Key Web Search CLI (package: zero_api_key_web_search)",
        epilog=(
            "Examples:\n"
