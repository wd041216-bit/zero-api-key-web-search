...
The canonical MCP command is ``cross-validated-search-mcp``.
The legacy ``free-web-search-mcp`` alias remains available for compatibility.
"""
import asyncio
import logging
import sys
...
logger = logging.getLogger("cross-validated-search-mcp")

app = Server("cross-validated-search")
