...
from cross_validated_search.core import EvidenceReportResult, UltimateSearcher
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  evidence-report \"Python 3.13 stable release\" --claim \"Python 3.13 is the latest stable release\" --deep --max-pages 2"
        ),
