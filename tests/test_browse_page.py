"""Unit tests for zerosieve.browse_page module."""
import sys
import unittest
import urllib.error
...
from zerosieve.browse_page import browse, extract_text
...
class TestBrowsePage(unittest.TestCase):
    ...
    @patch("zerosieve.browse_page.urllib.request.build_opener")
