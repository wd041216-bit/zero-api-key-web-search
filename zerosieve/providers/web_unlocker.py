...
from zerosieve.providers.base import ProviderConfigurationError
...
class WebUnlockerProvider:
    ...
    def unlock(
        ...
        from zerosieve.browse_page import extract_markdown, extract_text
